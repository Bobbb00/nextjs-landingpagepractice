...
const Feature = () => {
  return (
    <section className="mb-[50px] flex w-full flex-col items-center justify-center py-[80px]">
      ...
      <div className="mt-[50px] flex items-center justify-center gap-[120px]">
        <div className="flex flex-col items-center">
          ...
          <h3 className="mt-[20px] text-center text-[28px] font-bold">
            Drag & Drop Builder
          </h3>
          <p className="font-regular mt-[10px] text-center text-[15px]">
